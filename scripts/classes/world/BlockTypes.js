class BlockTypes {
  ...
  static OCEAN = new Block({ red: 35, green: 119, blue: 181 })
  static DEEP_OCEAN = new Block({ red: 22, green: 70, blue: 120 })
  static VERY_DEEP_OCEAN = new Block({ red: 15, green: 50, blue: 70 })
